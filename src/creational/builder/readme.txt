...
We can solve the issues with large number of parameters
 ...
 and then different setter methods to set the optional parameters.
  ...
  the Object state will be inconsistent 
  until unless all the attributes are set explicitly.

Builder pattern solves the issue with 
large number of optional parameters and inconsistent state 
