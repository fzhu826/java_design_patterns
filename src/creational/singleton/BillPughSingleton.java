...
/**
 * Prior to Java 5, java memory model had a lot of issues
 *  and above approaches used to fail in certain scenarios
 ...
 *I am using this approach in many of my projects
 * and it¡¯s easy to understand and implement als
 */
